...
/**
 * Core real-player / generated-player pool for the transfer market.
 * Covers all positions, ages 16–38, with varied potential and value.
 */
export const initialMarketPlayers: Player[] = [
  ...
  { id: "mkt-gk-02", name: "A. Restes",        age: 19, position: Position.GK,  attack: 12, defense: 72, stamina: 70, injuryWeeks: 0, potential: 88, overall: 67, value: 1_200_000 },
